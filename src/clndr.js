...
;(function ( $, window, document, undefined ) {
    ...
    Clndr.prototype.createDayObject = function(day, monthEvents) {
        ...
        if(this.options.constraints) {
            ...
            if (this.options.constraints.invalidDates && $.isArray(this.options.constraints.invalidDates)) {
                $.each(this.options.constraints.invalidDates, function (elem, index) {
                    if (
                        !day.isBefore(moment( index )) &&
                            !day.isAfter(moment( index ))
                        ) {
                        extraClasses += " inactive";
                    }
                });
